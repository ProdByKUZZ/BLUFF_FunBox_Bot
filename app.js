...
if (window.Telegram && Telegram.WebApp) {
    ...
    // Настройка цветов
    Telegram.WebApp.setHeaderColor('#2b5278');
    ...
    if (user) {
      ...
      const username = document.querySelector('.profile-info p');
  ...
  // Проверка на платформу Telegram
if (window.Telegram && Telegram.WebApp) {
  ...
  // Основная кнопка
  Telegram.WebApp.MainButton.text = 'Начать игру';
